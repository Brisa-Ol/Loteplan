                            ...
                            <Stack direction="row" spacing={2} alignItems="center">
                                ...
                                <Box>
                                    ...
                                    <Typography variant="caption" color="text.secondary" display={{ sm: 'none' }}>
                                        {pago.fecha_pago 
                                            ? new Date(pago.fecha_pago).toLocaleDateString(env.defaultLocale) 
                                            : 'Fecha desconocida'
                                        }
                                    </Typography>
                                </Box>
                        ...
                        <Box width="30%" display={{ xs: 'none', sm: 'block' }}>
                            <Stack direction="row" spacing={1} alignItems="center">
                                ...
                                <Typography variant="body2" color="text.secondary">
                                    {pago.fecha_pago 
                                        ? new Date(pago.fecha_pago).toLocaleDateString(env.defaultLocale) 
                                        : new Date(pago.fecha_vencimiento).toLocaleDateString(env.defaultLocale)
                                    }
                                </Typography>
                            </Stack>
                        </Box>
