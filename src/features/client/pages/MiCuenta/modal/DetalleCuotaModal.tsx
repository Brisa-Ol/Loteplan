...
import {
  Box, Typography, Stack, Paper, Divider, alpha, useTheme, Tooltip
} from '@mui/material';
import { ReceiptLong, LocalShipping, Calculate, TrendingUp, Savings, InfoOutlined } from '@mui/icons-material';

import { env } from '@/core/config/env';
import type { ResumenCuentaDto } from '@/core/types/dto/resumenCuenta.dto';
import { BaseModal } from '@/shared/components/domain/modals/BaseModal/BaseModal'; // ✅ Importación de BaseModal
...
export const DetalleCuotaModal: React.FC<Props> = ({ open, onClose, resumen }) => {
  ...
  return (
    <BaseModal
      ...
      subtitle={`${resumen.nombre_proyecto} • Cuota actual`}
      icon={<ReceiptLong />}
      headerColor="primary"
      maxWidth="md"
      hideConfirmButton // ✅ Solo queremos el botón de Cerrar
      cancelText="Cerrar"
    >
