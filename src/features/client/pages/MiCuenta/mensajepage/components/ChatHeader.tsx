...
const ChatHeader: React.FC<Props> = ({ activeChat, systemId, selectedContactId }) => {
  const theme = useTheme();

  const isSupport = selectedContactId === systemId;
    ...
    >
      ...
      <Box>
        <Typography variant="subtitle1" fontWeight="bold">
          {isSupport ? 'Soporte Técnico' : activeChat?.contactName}
        </Typography>
        {isSupport && (
