...
import { Alert, AlertTitle, Avatar, Box, Button, Card, CardContent, Divider, List, ListItem, ListItemIcon, ListItemText, Stack, Typography, alpha, useTheme } from '@mui/material';
    ...
    return (
        <Card elevation={0} sx={{ mb: 4, borderRadius: 3, border: `1px solid ${theme.palette.divider}` }}>
            <CardContent sx={{ p: 4 }}>
                ...
                {/* NUEVO AVISO DE DOCUMENTACIÓN */}
                <Box sx={{ mt: 4 }}>
                    <Alert severity="warning" sx={{ borderRadius: 2, alignItems: 'center' }}>
                        <AlertTitle sx={{ fontWeight: 'bold', mb: 0.5 }}>
                            Importante sobre tu documentación
                        </AlertTitle>
                        <Typography variant="body2">
                            Si utilizas <strong>Pasaporte o Licencia</strong> y los números registrados no concuerdan exactamente con el numero de documento registrado, tu solicitud podría ser rechazada. En caso de que esto ocurra, por favor <strong>contacta a nuestro equipo de soporte</strong> para aclarar la situación y validar tu cuenta manualmente.
                        </Typography>
                    </Alert>
                </Box>
