// Código completo con mejoras responsive
  ...
  return (
    <Stack spacing={3} maxWidth="sm" mx="auto">
      ...
      <Paper variant="outlined" sx={{ overflow: "hidden", borderRadius: 2 }}>
        {/* Header */}
        <Box sx={{ bgcolor: "primary.main", color: "primary.contrastText", p: { xs: 1.5, sm: 2 } }}>
        ...
        <Stack spacing={0}>
          ...
          <Box p={{ xs: 1.5, sm: 2 }} bgcolor={alpha(theme.palette.primary.main, 0.02)}>
            <Typography
              variant="overline"
              color="primary.main"
              fontWeight={800}
