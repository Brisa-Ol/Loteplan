// src/components/Admin/Proyectos/AssignLotesModal.tsx
...
import type { ProyectoDTO, AssignLotesDTO } from '../../../types/dto/proyecto.dto';
...
interface AssignLotesModalProps {
  open: boolean;
  onClose: () => void;
  onSubmit: (proyectoId: string, data: AssignLotesDTO) => Promise<void>;
...
const AssignLotesModal: React.FC<AssignLotesModalProps> = ({ 
  ...
  const handleSubmit = async () => {
    ...
    try {
      await onSubmit(proyecto.id.toString(), {
                ...
                <li {...props}>
                  ...
                  <Box>
                    ...
                    <Typography variant="caption" color="text.secondary">
                      ID: {option.id} • Precio Base: ${option.precio_base.toLocaleString()}
                    </Typography>
                  </Box>
                </li>
              )}
