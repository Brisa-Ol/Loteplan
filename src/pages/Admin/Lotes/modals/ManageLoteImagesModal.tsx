...
import {
  ...
  IconButton, Stack, Alert, useTheme, alpha, Avatar, Tooltip, CircularProgress,
...
import type { ImagenDto, CreateImagenDto } from '../../../../types/dto/imagen.dto';
...
const ManageLoteImagesModal: React.FC<ManageLoteImagesModalProps> = ({
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['adminLotes'] }); // Actualizar lista principal si muestra contadores
