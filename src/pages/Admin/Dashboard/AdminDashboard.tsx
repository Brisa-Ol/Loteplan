...
import {
  Box, Typography, Paper, Card, CardContent, Avatar, Stack,
...
const AdminDashboard: React.FC = () => {
  ...
  // Estado para el selector de proyecto en la pestaña de Popularidad
  ...
  // Efecto para seleccionar el primer proyecto por defecto cuando carguen
  useEffect(() => {
            ...
            <CardContent>
              {loadingPopularidad ? (
                  ...
                  <Alert severity="info" variant="outlined">
                      No hay lotes marcados como favoritos en el proyecto seleccionado.
                  </Alert>
              )}
            </CardContent>
          </Card>
            ...
            <Card variant="outlined" sx={{ borderRadius: 2 }}>
              <CardContent sx={{ display: 'flex', alignItems: 'center', gap: 3 }}>
                ...
                <Box>
                  ...
                  <Button variant="contained" size="small" sx={{ mt: 1 }} onClick={() => navigate('/admin/pujas')}>Ir a Sala</Button>
                </Box>
              </CardContent>
            </Card>
            <Card variant="outlined" sx={{ borderRadius: 2 }}>
