// src/pages/Proyectos/ProyectosInversionista.tsx (Corregido)
// ═══════════════════════════════════════════════════════════
...
// ❗ CORRECCIÓN 1: Importamos el servicio con llaves { }
import { proyectoService } from '../../../Services/proyecto.service'; 

const ProyectosInversionista: React.FC = () => {

  // ❗ CORRECCIÓN 2: Usamos el nombre de función correcto
  const { data: proyectos, isLoading, error } = useQuery<ProyectoDTO[], Error>({
    queryKey: ['proyectosInversionista'],
    queryFn: proyectoService.getProyectosInversionistas 
  });
